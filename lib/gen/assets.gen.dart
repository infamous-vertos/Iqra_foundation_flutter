...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/deposite.png
  AssetGenImage get deposite =>
      const AssetGenImage('assets/images/deposite.png');

  /// File path: assets/images/expense.png
  AssetGenImage get expense => const AssetGenImage('assets/images/expense.png');

  /// File path: assets/images/golden_line.png
  AssetGenImage get goldenLine =>
      const AssetGenImage('assets/images/golden_line.png');

  /// File path: assets/images/money.png
  AssetGenImage get money => const AssetGenImage('assets/images/money.png');

  /// File path: assets/images/spending.png
  AssetGenImage get spending =>
      const AssetGenImage('assets/images/spending.png');
...
class $AssetsLogoGen {
  ...
  /// File path: assets/logo/text_horizontal.png
  AssetGenImage get textHorizontal =>
      const AssetGenImage('assets/logo/text_horizontal.png');

  /// File path: assets/logo/text_vertical.png
  AssetGenImage get textVertical =>
      const AssetGenImage('assets/logo/text_vertical.png');
